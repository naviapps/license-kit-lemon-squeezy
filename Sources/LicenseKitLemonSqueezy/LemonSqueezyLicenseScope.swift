...
public struct LemonSqueezyLicenseScope: Equatable, Sendable {
  /// Accepts license keys from any Lemon Squeezy store, product, or variant.
  public static let any = Self()

  /// Accepted Lemon Squeezy store ID. When set, licenses from other stores are rejected.
  public let storeID: String?
  /// Accepted Lemon Squeezy product ID. When set, licenses from other products are rejected.
  public let productID: String?
  /// Accepted Lemon Squeezy variant IDs. When non-empty, other variants are rejected.
